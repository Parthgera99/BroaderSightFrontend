    ...
    <div className='p-8 pt-0 2xl:w-[1400px] 2xl:mx-auto'>
        ...
        <div className='flex flex-wrap gap-24 max-sm:gap-4 justify-center items-start p-8 max-sm:px-4'>
            ...
            <div className='flex flex-col gap-3 max-sm:px-32 items-center max-md:items-center'>
                ...
                <Link href="/contact-us" className='max-sm:hidden hover:underline duration-300'>Contact us</Link>
                <Link href="/about" className='max-sm:hidden hover:underline duration-300'>About us</Link>
                <Link href="/privacy-policy" className='max-sm:hidden hover:underline duration-300'>Privacy Policy</Link>
                <Link href="/t&c" className='max-sm:hidden hover:underline duration-300'>Terms & Conditions</Link>
            </div>
            <div className='w-[30%] max-lg:w-[40%] max-sm:mt-8 max-md:w-full flex flex-col justify-center items-center gap-5'>
                ...
                {/* x  */}
                <Link href="https://x.com/BroaderSight?t=J3Qt3HjqgFmYTbYlYk-ODA&s=09" target='_blank'>
                ...
                {/* facebook  */}
                <Link href="https://www.facebook.com/profile.php?id=61575250284605" target='_blank'>
                ...
                {/* instagram  */}
                <Link href="https://www.instagram.com/broadersight.blogs?igsh=MXAyNmtvcXJueGZ2MQ==" target='_blank'>
                    <img src='/instagram.svg' className='w-[24px] h-[24px]' alt='instagram'/>
                </Link>
                {/* linked in  */}
                <Link href="https://www.linkedin.com/company/broader-sight-blogs/about/" target='_blank'>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
