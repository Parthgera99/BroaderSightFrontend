...
// const page = async ({ params, searchParams }: { params: { slug: string }, searchParams: { filter?: string } }) => {
...
export async function generateMetadata({ params }: { params: { slug: string } }): Promise<Metadata> {
  ...
  return {
    title: `Explore ${slug[0].toUpperCase() + slug.slice(1)} Blogs | Broadersight`,
    description: `Read the latest blogs on ${slug[0].toUpperCase() + slug.slice(1)} on BroaderSight Blogs. Dive deep into curated content, expert insights, and trending authors on ${slug[0].toUpperCase() + slug.slice(1)}.`,
    openGraph: {
      title: `${slug[0].toUpperCase() + slug.slice(1)} Blogs | Broadersight`,
      description: `Read ${slug[0].toUpperCase() + slug.slice(1)} blogs on Broadersight. Stay updated with top content daily.`,
      url: `https://broadersight.com/category/${slug}`,
      siteName: "Broadersight Blogs",
      type: "website",
    },
    twitter: {
      card: "summary_large_image",
      title: `${slug} Blogs | Broadersight`,
      description: `Discover ${slug[0].toUpperCase() + slug.slice(1)} blogs and dive deep into curated content, expert insights, and trending authors.`,
    },
  };
}
